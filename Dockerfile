...
RUN kdist --verbose build evm-semantics.plugin
RUN K_OPTS='-Xmx32g -XX:+UseZGC' kdist --verbose build stylus-semantics.llvm
RUN K_OPTS='-Xmx32g -XX:+UseZGC' kdist --verbose build stylus-semantics.llvm-library
RUN skribe --help
